		...
		<div id="layoutSidenav_content">
			<main>
				...
				<div class="container-fluid px-4">
					...
					<div class="card mb-4">
						<div class="card-body">
							자주묻는질문 페이지 입니다. <a target="_blank" href="https://datatables.net/">아무링크</a>
							.
						</div>
					</div>
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-chart-area me-1"></i> 여기는 아래 표 또는 자주묻는 질문에 대한
							세부제목
						</div>
						...
						<table id="datatablesSimple"
							...
							<thead>
								...
								<tr>
									...
									<th width="50" col-index=2>No</th>
									<th width="120" col-index=3>분류</th>
							...
							<tbody>
								...
								<tr>
									...
									<td>3</td>
									<td>배송관리</td>
									<td>수거주소와 배송 주소가 달라도 되나요?</td>
								</tr>
								<tr>
									<td id="check_td"><input type="checkbox" name="check"></td>
									<td>4</td>
									<td>배송관리</td>
									<td>배송 가능 날짜와 시간을 알려주세요 ?</td>
								</tr>
								<tr>
									<td id="check_td"><input type="checkbox" name="check"></td>
									<td>5</td>
								...
								<tr>
									...
									<td>6</td>
									<td>주문관리</td>
									<td>입력한 주소를 수정하고 싶어요 ?</td>
								</tr>
								<tr>
									<td id="check_td"><input type="checkbox" name="check"></td>
									<td>7</td>
									<td>배송관리</td>
									<td>수거 예정 시간에 수거가 안됬어요.</td>
								</tr>
						...
						<div class="flex">
							<div>
								<input id="button" type="button" value="등록" onclick="window.location='/Team_Git/admin/board_FAQ_write.jsp'"/>
							</div>
							<div>
