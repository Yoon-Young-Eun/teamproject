...
<div class="b_button">
						...
						<table id=""
							...
							<tbody>
								<c:forEach var="coupon" items="${CouponPList}">
									<tr>
										<td id="check_td"><input type="checkbox" name="check"></td>
										<td>${coupon.coupon_management_no}</td>
										<td>${coupon.coupon_management_status}</td>
										<td>${coupon.coupon_management_name}</td>  
										<td>${coupon.coupon_management_start_date}</td>
										<td>${coupon.coupon_management_end_date}</td>
										<td>${coupon.coupon_management_price}</td>
										<td>${coupon.customer_no}</td>
