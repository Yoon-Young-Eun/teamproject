...
public class Ad_ChartController {
	...
	@RequestMapping("/getMainBoardArea.mdo")
	public @ResponseBody List<OrderMtVO> getMainBoardArea(PagingVO pvo){
		List<OrderMtVO> mainArea = dash.getMainBoardArea();
		
		return mainArea; 
				
	}
	
	@RequestMapping("/getMainBoardBar.mdo")
	public @ResponseBody List<OrderVO> getMainBoardBar(PagingVO pvo){
		List<OrderVO> mainBar = dash.getMainBoardBar();
		return mainBar; 		
	}
	
	@RequestMapping("/getMainBoardDoughnut.mdo")
	public @ResponseBody List<OrderMtVO> getMainBoardDoughnut(PagingVO pvo){
		List<OrderMtVO> mainDoughnut = dash.getMainBoardDoughnut();
		return mainDoughnut; 			
	}	
	...
	public @ResponseBody List<OrderMtVO> getDoughnutChart(PagingVO pvo)throws Exception {
	...
	public @ResponseBody List<OrderVO> getBarChart(PagingVO pvo)throws Exception {
	...
	public @ResponseBody List<OrderVO> getMainBarChart(PagingVO pvo)throws Exception {
		System.out.println("바차트 pvo 값 : "+pvo);
	...
	public @ResponseBody List<OrderMtVO> getMainAreaChart(PagingVO pvo)throws Exception {
