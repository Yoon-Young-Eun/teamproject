...
<div class="wrap">
  ...
  <form action="/OrderOrder.do" id="form1">
    ...
    <div class="service3">
      <input type="text" value="${Data.data2}" readonly id="checkbox" name="order_request2">
    </div>
    <div class="service3">
      <input type="text" value="${Data.data3}" readonly id="checkbox" name="order_request2">
    </div>
    <div class="service3">
      <input type="text" value="${Data.data4}" readonly id="checkbox" name="order_request2">
    </div>
    <div class="service3">
      <input type="text" value="${Data.data5}" readonly id="checkbox1" name="order_request2">
    </div>
