...
<!--                             </div> -->
    ...
    <table id="datatablesSimple" class="emp-table dataPerPage tblCustomers tblexportData table" border="5">
        ...
        <tr>
            ...
            <th width="120px;" col-index = 2>배너번호</th>
            <th width="120px;" col-index = 3>배너이름</th>

            <th width="400px;"col-index = 4>배너파일</th>
              <th width="120px;" col-index = 5>내용</th>
            <tr>
        </thead>
        <tbody>
            <tr>
            <td id="check_td"><input type="checkbox" name="check"></td>
                <td>101</td>
                <td>banner 1</td>
                <td><img src="./image/banner01.jpg"></td>
                <td>ㅎㅎㅎㅎ배너</td>
