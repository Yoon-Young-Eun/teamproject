					...
					<div class="card mb-4" style="width: 100%; overflow-x: auto;">
						...
						<div class="card mb-4">
							...
							<div class="chartparent">
								...
								<form id="doughnutChart">
									
										<div class="chart_flex">
										<div>
									<select id="doughnutChart" name="searchKeyword" >
										<option value="">검색</option>
										<c:forEach items="${search2}" var="store">
										<option value="${store.order_store_name}">${store.order_store_name}</option>
										</c:forEach>
									</select>
								</div>
											<div>
											...
											<div>
												<input type="button" value="검색" onClick="drawChart()" />
											</div>
											<div>
												<input type="reset" value="초기화" onChange="drawChart()" />
											</div>
										</div>
									</form>
								</div>
