...
<link rel="stylesheet" href="/css/myAddressSet.css">
...
<body>
    ...
    <form action="/setmyAddress.do" method="GET">
    ...
    <div class="main_text2">	
      ...
      <div class="main_text4">
        <input type="text" value="" id="b1" placeholder="집 / 회사 등" name="cm_address_name" required> 
      </div>
    </div>
      <div class="main_text5">
        ...
        <div class="main_text4">
          <input type="text" value="" id="b2" placeholder="우편번호 찾기" readonly name="cm_address1" required> 
     ...
     <div class="main_text7">
      ...
      <div class="main_text4">
        <input type="text" value="" id="b4" placeholder="나머지 주소 입력" name="cm_address2" required> 
      </div>
   </div>
     <div class="main_text6">
      ...
      <div class="main_text4">
        <input type="tel"  name="cm_phone_number" id="b3" required pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}" maxlength="13" placeholder="예) 010-1234-5678" />
      </div>
     </div>
