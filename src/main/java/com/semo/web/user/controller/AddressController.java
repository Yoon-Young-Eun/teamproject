...
public class AddressController {
	...
	public String getAddressList(AddressListVO avo, Model model, CustomerVO vo,HttpSession session) {
		session.getAttribute("id");
		if(session.getAttribute("id") != null) {
			System.out.println(vo);
	...
	public String getAddressList1(AddressListVO vo, Model model,HttpSession session) {
		session.getAttribute("id");
		if(session.getAttribute("id") != null) {
			System.out.println(vo);
	...
	public String deleteAddressList(AddressListVO vo, Model model,HttpSession session) {
		session.getAttribute("id");
		if(session.getAttribute("id") != null) {
			System.out.println(vo);
	...
	public String updateAddressList(AddressListVO vo, Model model,HttpSession session) {
		session.getAttribute("id");
		if(session.getAttribute("id") != null) {
			System.out.println(vo);
	...
	public String sendAddressList(AddressListVO vo, Model model, HttpSession session) {
		session.getAttribute("id");
		if(session.getAttribute("id") != null) {
	...
	public String sendCustomer(CustomerVO vo,Model model,HttpSession session) {
		session.getAttribute("id");
		if(session.getAttribute("id") != null) {
			System.out.println(vo);
	...
	@RequestMapping(value="/updateCustomerAddress.do",method = RequestMethod.GET)
	public String updateCustomerAddress(AddressListVO vo,CustomerVO vo1,Model model,HttpSession session) {
		session.getAttribute("id");
		if(session.getAttribute("id") != null) {
			System.out.println(vo);
	 ...
	 */
	 //비밀번호찾기 인증번호 메세지 보내기
		...
		public String myAddress(CustomerVO vo,Model model,HttpSession session) {
			session.getAttribute("id");
			if(session.getAttribute("id") != null) {
				System.out.println(vo);
				System.out.println("sendCustomer 메서드 실행");
		...
		public String updatemyAddress(AddressListVO vo,CustomerVO vo1,Model model,HttpSession session) {
			session.getAttribute("id");
			if(session.getAttribute("id") != null) {
				System.out.println(vo);
		...
		public String sendmyAddressList(AddressListVO vo, Model model,HttpSession session) {
			session.getAttribute("id");
			if(session.getAttribute("id") != null) {
				System.out.println("글자" + vo);
				System.out.println("sendAddressList 메서드 실행");
		...
		public String updatemyAddressList(AddressListVO vo, Model model,HttpSession session) {
			session.getAttribute("id");
			if(session.getAttribute("id") != null) {
				System.out.println(vo);
				System.out.println("updateAddressList 메서드 실행");
		...
		public String deletemyAddressList(AddressListVO vo, Model model,HttpSession session) {
			session.getAttribute("id");
			if(session.getAttribute("id") != null) {
				System.out.println(vo);
				System.out.println("deleteAddressList 메서드 실행");
		...
		public String getmyAddressList1(AddressListVO vo, Model model,HttpSession session) {
			session.getAttribute("id");
			if(session.getAttribute("id") != null) {
				System.out.println(vo);
				System.out.println("getAddress1 메서드 실행");
