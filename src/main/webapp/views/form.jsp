...
<!-- resources -->
<link rel="stylesheet" href="/views/resources/css/form.css" />
					...
					<table class="tableWrap">
						<tbody class="personalInfo">
							<tr>
								...
								<td class="tableTitle"><input class="inputBox" id="email1"
									onkeyup="idCheck()" type="text" class="box" name="customer_id"> <span
									class="text">예) example@mail.com</span> <span id="checking"></span>
									</td>
							</tr>
							<tr>
