...
<div class = "page-wrapper">
	...
	<div class = "content-wrapper">
		...
		<!-- 글쓰기 -->
		<form action="/updateask.do" method = "get" name = "insertForm">
		<input type="hidden" name="board_qna_no" value="${data.board_qna_no}"/>
		...
		<div class = "article-wrapper">
			...
			<div class = "article-title-wrapper">
				...
				<input name = "board_qna_title" id = "title" value = "${data.board_qna_title }" class = "artice-title-content" type = "text">
			</div>
			<div class = "article-content-wrapper">
				<div class = "article-content-title">내용</div>
				<textarea name = "board_qna_content" id = "content" class = "artice-content-content">${data.board_qna_content }</textarea>
			</div>
			<div></div>
		</div>
		<div class = "button-wrapper">
			<a href="/myasklist.do?customer_no=${num}" class="action-button shadow animate grey" style = "height : 30px;">취소</a>	
			<a type="submit" id = "insert" class="action-button shadow animate blue" style = "height : 30px;">수정</a>	
		</div>
		</form>
	</div><!-- content-wrapper -->	
</div><!-- page-wrapper -->
