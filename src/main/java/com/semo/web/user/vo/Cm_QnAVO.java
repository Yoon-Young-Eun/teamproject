...
=======
	...
	public String toString() {
		return "Cm_QnAVO [board_qna_no=" + board_qna_no + ", board_qna_type=" + board_qna_type + ", board_qna_title="
				+ board_qna_title + ", board_qna_content=" + board_qna_content + ", board_qna_filepath="
				+ board_qna_filepath + ", board_qna_reg_date=" + board_qna_reg_date + ", board_qna__status="
				+ board_qna_status + ", customer_no=" + customer_no + ", admin_qna_title=" + admin_qna_title
				+ ", admin_qna_content=" + admin_qna_content + ", admin_qna_reg_date=" + admin_qna_reg_date
				+ ", getBoard_qna_no()=" + getBoard_qna_no() + ", getBoard_qna_type()=" + getBoard_qna_type()
				+ ", getBoard_qna_title()=" + getBoard_qna_title() + ", getBoard_qna_content()="
				+ getBoard_qna_content() + ", getBoard_qna_filepath()=" + getBoard_qna_filepath()
				+ ", getBoard_qna_reg_date()=" + getBoard_qna_reg_date() + ", getBoard_qna__status()="
				+ getBoard_qna_status() + ", getCustomer_no()=" + getCustomer_no() + ", getAdmin_qna_title()="
				+ getAdmin_qna_title() + ", getAdmin_qna_content()=" + getAdmin_qna_content()
				+ ", getAdmin_qna_reg_date()=" + getAdmin_qna_reg_date() + ", getClass()=" + getClass()
