		...
		<div class="container-fluid px-4">
			...
			<div class="card mb-4">
				<div class="card-header">
					<i class="fas fa-chart-area me-1"></i> 여기는 아래 표 또는 notice에 대한 세부제목
				</div>
						...
						<c:forEach var="review" items="${ReviewList}">
							<tr class="colored"
								...
								<td><c:choose>
									...
									</c:choose> ${review.board_review_rating}</td>
				...
				<div class="flex">
					...
					<div>
						<input id="delBtn" type="button" value="삭제"
							onclick="return confirm('선택한 리뷰정보를 삭제하시겠습니까?');" />
					</div>
				</div>
						...
						<div class="icon_flex">
							<div>
								<c:if test="${startPage > pageBlock}">
									...
									<a
										href="ReviewBoardList.mdo?pageNum=${startPage-pageBlock}&selectPage=${search.selectPage}&searchKeyword=${search.searchKeyword}&searchCondition=${search.searchCondition}"><div
							...
							<div class="icon_flex">
								<c:forEach var="i" begin="${startPage}" end="${endPage}">
									<a
										href="ReviewBoardList.mdo?pageNum=${i}&selectPage=${search.selectPage}&searchKeyword=${search.searchKeyword}&searchCondition=${search.searchCondition}"><div
